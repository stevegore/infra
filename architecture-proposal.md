...
- [x] API endpoint NSG — TCP 6443 from home IP (`203.0.113.4/32`) only. Bumped the NSG rule's CIDR if/when home IP changes (see `terraform/oke-networking.tf`).
